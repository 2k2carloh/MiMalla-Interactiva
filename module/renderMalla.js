...
function renderMalla() {
  ...
  filas.forEach(fila => {
    ...
    fila.forEach(semestre => {
      ...
      divSemestre.style.backgroundColor = estilo.estiloFondoSemestres || '#fafafa';
      divSemestre.style.borderColor = estilo.estiloBordeColor || '#ddd';
      divSemestre.style.color = estilo.estiloTexto || '#000';
      ...
      btnAddRamo.style.backgroundColor = estilo.estiloBotones || '#000';
      btnAddRamo.style.color = '#fff';
